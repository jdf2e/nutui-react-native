...
const ActionSheetDemo = () => {
  ...
  return (
      <DemoPage >
          <DemoCard title={translated['74fc5d8a']}>
          <Cell
          ...
          <Cell 
            isLink 
            title={translated['595d7bb3']}
            onPress={() => setIsVisible2(!isVisible2)}/>
         

          <Cell 
          isLink 
           title={translated['0a1a6656']}
           onPress={() => setIsVisible3(!isVisible3)}/>
    
         </DemoCard>

         <DemoCard title={translated['c3a08064']}>
         <Cell 
         isLink
         title={translated['c3a08064']} 
         onPress={() => setIsVisible4(!isVisible4)}/>
    
         </DemoCard>


         <DemoCard title={translated['c3a08065']}>
         <Cell 
         isLink
         title={translated['c3a08065']} 
         onPress={() => setIsVisible5(!isVisible4)}/>
        ...
        >
          { <View style={{width:'100%',height:100,backgroundColor:'#fff',justifyContent:"center",alignItems:'center' }}><Text>1223</Text></View> }
        </ActionSheet>
      </DemoPage>
  )
}
